...
TEST_F( takeActionTest, doesComment ) {
  ...
  EXPECT_EQ( (int)(mInputStream.str( ).size( ) - remains.size( )), (int)mInputStream.tellg( ) );
...
TEST_F( takeActionTest, takeActionComplainsAboutUnrecognizedCommands ) {
...
TEST_F( takeActionTest, takeActionComplainsAboutUnrecognizedCommands2 ) {
