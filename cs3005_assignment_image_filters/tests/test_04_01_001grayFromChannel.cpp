...
class grayFromChannelTest : public ::testing::Test {
protected:
...
TEST_F( grayFromChannelTest, setsMetaData ) {
  ...
  const PPM& ppm_orig_const = mPPM;
const PPM& ppm_gray_const = mFilteredPPM;
  ppm_orig_const.grayFromChannel( mFilteredPPM, 0 );
...
TEST_F( grayFromChannelTest, setsMetaDataAgain ) {
...
TEST_F( grayFromChannelTest, setsGrayFromRed ) {
...
TEST_F( grayFromChannelTest, setsGrayFromRedAgain ) {
...
TEST_F( grayFromChannelTest, setsGrayFromGreen ) {
  ...
  const PPM& ppm_orig_const = mPPM;
const PPM& ppm_gray_const = mFilteredPPM;
  ppm_orig_const.grayFromChannel( mFilteredPPM, 1 );
...
TEST_F( grayFromChannelTest, setsGrayFromGreenAgain ) {
...
TEST_F( grayFromChannelTest, setsGrayFromBlue ) {
  ...
  const PPM& ppm_orig_const = mPPM;
const PPM& ppm_gray_const = mFilteredPPM;
  ppm_orig_const.grayFromChannel( mFilteredPPM, 2 );
...
TEST_F( grayFromChannelTest, setsGrayFromBlueAgain ) {
