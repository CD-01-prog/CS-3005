...
class FindVerticalEdgesTest : public ::testing::Test {
protected:

  FindVerticalEdgesTest( )
...
TEST_F( FindVerticalEdgesTest, setsMetaData ) {
  ...
  ppm_orig_const.findVerticalEdges( filtered_ppm );
...
TEST_F( FindVerticalEdgesTest, setsPixelData ) {
